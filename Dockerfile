...
# Build VMware Tools
ENV OVT_VERSION 10.0.5.s1
ENV OVT_VENDOR sevikkk

RUN curl --retry 10 -fsSL "https://github.com/${OVT_VENDOR}/open-vm-tools/archive/open-vm-tools-${OVT_VERSION}.tar.gz" | tar -xz --strip-components=1 -C /
